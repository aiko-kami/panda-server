...
const useChangeEmailAddressVerificationTemplate = (emailInputs) => {
	...
	const emailContent = `<table border="0" width="100%" cellspacing="0" cellpadding="0" bgcolor="#f4f4f4"><tbody><tr><td><table style="max-width:600px;margin:auto;background-color:#fff;padding:20px" border="0" width="100%" cellspacing="0" cellpadding="0" align="center"><tbody><tr><td style="text-align:center;padding:10px"><h2>You changed your email address!</h2></td></tr><tr><td style="padding:20px"><p>Hello <strong>${usernameCapitalized}</strong>,</p><p>To complete your email change, please click the link below:</p><p>&nbsp;</p><p style="text-align:center"><a style="display:inline-block;padding:10px 20px;background-color:#007bff;color:#fff;text-decoration:none;border-radius:5px" href="${verificationLink}">Validate my new email</a></p><p>&nbsp;</p><p>If you didn’t initiate this email change on Make It, reach out to our support team.</p><p>&nbsp;</p><p>See you soon.</p><p style="text-align:right"><br>Sheppy team</p></td></tr></tbody></table></td></tr></tbody></table>`;
